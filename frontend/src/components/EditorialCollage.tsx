      ...
      */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 h-auto lg:h-[800px] mb-4">
        ...
        <div className="lg:col-span-8 h-[500px] lg:h-full relative group overflow-hidden">
          <img
            src="/images/collections/nueva-coleccion.png"
            alt="Nueva Colección"
            className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out"
          />
          <div className="absolute inset-0 bg-black/20" />
          <div className="absolute bottom-32 md:bottom-48 left-10 text-white z-10 max-w-sm">
        ...
        <div className="lg:col-span-4 flex flex-col gap-4 h-[800px] lg:h-full">
          ...
          <div className="flex-1 relative group overflow-hidden bg-stone-100">
            <img
              src="/images/collections/detalles-enamorar.png"
              alt="Detalles"
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 ease-out"
            />
          ...
          {/* Bottom Image Block */}
          <div className="flex-1 relative group overflow-hidden text-white flex flex-col justify-center items-center text-center">
            <img
              src="/images/collections/regalar-intencion.png"
            ...
            <div className="relative z-10 p-10 flex flex-col justify-center items-center text-center">
              <span className="text-xs tracking-[0.2em] font-medium uppercase mb-4 text-stone-200">
                Regalos especiales
              </span>
              ...
              <Link
                to="/catalogo?categoria=Edición%20Regalo"
                className="bg-white text-black px-8 py-3 text-xs tracking-widest uppercase font-semibold hover:bg-stone-200 transition-colors"
              >
                Ver opciones
              </Link>
            </div>
      ...
      <div className="w-full relative h-[300px] overflow-hidden group mt-4">
        <img
          src="/images/collections/belleza-sutil.png"
          alt="Campaign"
