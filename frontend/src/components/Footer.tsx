        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a   href="https://pin.it/55qBM5iaU" className="text-sm text-stone-400 hover:text-white transition-colors">Pinterest</a></li>
              <li><a   href="https://www.tiktok.com/@upminaa.cos?_r=1&_t=ZS-96kzLspntlX" className="text-sm text-stone-400 hover:text-white transition-colors">TikTok</a></li>
            </ul>
          </div>
